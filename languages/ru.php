...
$txt['warn_move_next'] = 'Будет перемещено не только текущее сообщение, но и все более поздние из исходной темы. Продолжить?';
$txt['unit_settings'] = 'Настройки';
$txt['topics_view_setting'] = 'Вид списка';
$txt['topics_view_standart'] = 'Стандартный';
$txt['topics_view_middle'] = 'Средний';
$txt['topics_view_short'] = 'Компактный';
$txt['topics_sort_setting'] = 'Сортировка';
$txt['topics_sort_updated'] = 'По дате обновления';
$txt['topics_sort_created'] = 'По дате создания';
$txt['topics_sort_name'] = 'По названию';
$txt['topics_sort_author'] = 'По имени автора';
$txt['topics_sort_postsquant'] = 'По количеству сообщений';
$txt['topics_sortdir_setting'] = 'Направление сортировки';
...
$txt['connection_error'] = 'Ошибка подключения к серверу. Пробуем переподключиться';
