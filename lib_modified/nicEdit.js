...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'libraries/nicEditorIcons.gif',
...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		var panelElm = new bkElement('DIV').setStyle({width : '100%'/*(parseInt(e.getStyle('width')) || e.clientWidth)+'px'*/}).appendBefore(e);
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: '100%'/*newX+'px'*/, border : '1px solid #ccc', borderTop : 0, overflowY : 'hidden', overflowX: 'hidden' };
			s[(ie7s) ? 'height' : 'maxHeight'] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight+'px' : null;
			this.editorContain = new bkElement('DIV').setStyle(s).appendBefore(e);
			var editorElm = new bkElement('DIV').setStyle({/*width : '99%'(newX-8)+'px',*/ padding: '4px', minHeight : newY+'px'}).addClass('main').appendTo(this.editorContain);
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '100%', backgroundColor : '#efefef'}).addClass('panelContain');
